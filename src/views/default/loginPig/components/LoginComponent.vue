    ...
    <div class="container">
      ...
      <div class="login-tabs-cover">
        ...
        <template v-if="activeName === 'username'">
          <userNameLogin ref="loginCom" v-bind="$attrs" />
        </template>
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const refreshCode = () => {
      that.loginCom.refreshCode()
    }
    const closeLoading = () => {
      that.loginCom.closeLoading()
    }
    return {
      ...toRefs(that), handleTabNav, activeName, refreshCode, closeLoading
    }
  }
})
</script>
