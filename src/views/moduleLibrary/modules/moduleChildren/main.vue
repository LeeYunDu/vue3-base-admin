        ...
        <div>
          <query-form :data="queryFormData" @setParam="setParam">
            <template #formItem>
              ...
              <el-form-item>
                <el-button size="small" type="success" @click="exportData">数据导出</el-button>
              </el-form-item>
...
export default defineComponent({
  ...
  setup() {
    ...
    const testData = ref([
      {
        idCard: '330327199610097270', name: '测试用例', phone: '15168766725', selectIds: [], selectLabels: '测试选人组件',
    ...
    const tabelColumn = ref([
      ...
      { label: '联系方式', width: '200px', prop: 'phone' },
      { label: '身份证号', minWidth: '300px', prop: 'idCard' },
      { label: '操作', width: '400px', prop: 'date', render: (h, params) => {
    ...
    return {
      ...
      exportData, testData, tableApi, handleSuccess
    }
  }
})
</script>
